...
//#include <WString.h>
#include "../.../../../arduino-core/WString.h"
...
struct MarlinSerialCfg {
    ...
    static constexpr bool XONOFF = (SERIAL_XON_XOFF);
    //static constexpr bool EMERGENCYPARSER = ENABLED(EMERGENCY_PARSER);
    static constexpr bool EMERGENCYPARSER = (EMERGENCY_PARSER);
    //static constexpr bool DROPPED_RX = ENABLED(SERIAL_STATS_DROPPED_RX);
    static constexpr bool DROPPED_RX = (SERIAL_STATS_DROPPED_RX);
    //static constexpr bool RX_OVERRUNS = ENABLED(SERIAL_STATS_RX_BUFFER_OVERRUNS);
    static constexpr bool RX_OVERRUNS = (SERIAL_STATS_RX_BUFFER_OVERRUNS);
    //static constexpr bool RX_FRAMING_ERRORS = ENABLED(SERIAL_STATS_RX_FRAMING_ERRORS);
    static constexpr bool RX_FRAMING_ERRORS = (SERIAL_STATS_RX_FRAMING_ERRORS);
    //static constexpr bool MAX_RX_QUEUED = ENABLED(SERIAL_STATS_MAX_RX_QUEUED);
    static constexpr bool MAX_RX_QUEUED = (SERIAL_STATS_MAX_RX_QUEUED);
};
...
#if defined(USBCON) && defined(BLUETOOTH)
