...
#if !defined(X2_USE_ENDSTOP) && defined(X_DUAL_ENDSTOPS) && PIN_EXISTS(X_STOP)
...
#if !defined(Y2_USE_ENDSTOP) && defined(Y_DUAL_ENDSTOPS) && PIN_EXISTS(Y_STOP)
...
#if defined(Z_MULTI_ENDSTOPS) && PIN_EXISTS(Z_STOP)
...
#if !defined(USE_XMIN_PLUG) && !defined(USE_XMAX_PLUG)
#undef X_STOP_PIN
#endif
...
#if !defined(USE_YMIN_PLUG) && !defined(USE_YMAX_PLUG)
#undef Y_STOP_PIN
#endif
...
#if !defined(USE_ZMIN_PLUG) && !defined(USE_ZMAX_PLUG)
#undef Z_STOP_PIN
#endif
//#if DISABLED(USE_IMIN_PLUG)
#if !defined(USE_IMIN_PLUG)
#undef I_MIN_PIN
#define I_MIN_PIN          -1
#endif
//#if DISABLED(USE_IMAX_PLUG)
#if !defined(USE_IMAX_PLUG)
#undef I_MAX_PIN
#define I_MAX_PIN          -1
#endif
//#if NONE(USE_IMIN_PLUG, USE_IMAX_PLUG)
#if !defined(USE_IMIN_PLUG) && !defined(USE_IMAX_PLUG)
#undef I_STOP_PIN
#endif
//#if DISABLED(USE_JMIN_PLUG)
#if !defined(USE_JMIN_PLUG)
#undef J_MIN_PIN
#define J_MIN_PIN          -1
#endif
//#if DISABLED(USE_JMAX_PLUG)
#if !defined(USE_JMAX_PLUG)
#undef J_MAX_PIN
#define J_MAX_PIN          -1
#endif
//#if NONE(USE_JMIN_PLUG, USE_JMAX_PLUG)
#if !defined(USE_JMIN_PLUG) && !defined(USE_JMAX_PLUG)
#undef J_STOP_PIN
#endif
...
#if !defined(USE_KMAX_PLUG)
#undef K_MAX_PIN
#define K_MAX_PIN          -1
#endif
//#if NONE(USE_KMIN_PLUG, USE_KMAX_PLUG)
#if !defined(USE_KMIN_PLUG) && !defined(USE_KMAX_PLUG)
#undef K_STOP_PIN
#endif
//#if DISABLED(USE_UMIN_PLUG)
#if !defined(USE_UMIN_PLUG)
#undef U_MIN_PIN
#define U_MIN_PIN          -1
#endif
//#if DISABLED(USE_UMAX_PLUG)
#if !defined(USE_UMAX_PLUG)
#undef U_MAX_PIN
#define U_MAX_PIN          -1
#endif
//#if NONE(USE_UMIN_PLUG, USE_UMAX_PLUG)
#if !defined(USE_UMIN_PLUG) && !defined(USE_UMAX_PLUG)
#undef U_STOP_PIN
#endif
//#if DISABLED(USE_VMIN_PLUG)
#if !defined(USE_VMIN_PLUG)
#undef V_MIN_PIN
#define V_MIN_PIN          -1
#endif
//#if DISABLED(USE_VMAX_PLUG)
#if !defined(USE_VMAX_PLUG)
#undef V_MAX_PIN
#define V_MAX_PIN          -1
#endif
//#if NONE(USE_VMIN_PLUG, USE_VMAX_PLUG)
#if !defined(USE_VMIN_PLUG) && !defined(USE_VMAX_PLUG)
#undef V_STOP_PIN
#endif
...
#if !defined(USE_WMIN_PLUG) && !defined(USE_WMAX_PLUG)
#undef W_STOP_PIN
#endif
