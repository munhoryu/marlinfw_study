...
#if !defined(FET_ORDER_EEF) && !defined(FET_ORDER_EEB) && !defined(FET_ORDER_EFF) && !defined(FET_ORDER_EFB) && !defined(FET_ORDER_SF)
...
#if !(defined(HAS_WIRED_LCD) && defined(IS_NEWPANEL)) && (defined(PANEL_ONE) || defined(VIKI2) || defined(miniVIKI) || defined(WYH_L12864) || defined(MINIPANEL) || defined(REPRAPWORLD_KEYPAD))
...
#define NOT_TARGET(...) NONE(##_VA__ARGS__)
#endif
...
#pragma "Unknown MOTHERBOARD value set in Configuration.h."
#else
