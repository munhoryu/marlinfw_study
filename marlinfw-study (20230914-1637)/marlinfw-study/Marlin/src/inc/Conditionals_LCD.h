...
#if defined(MKS_LCD12864A) || defined(MKS_LCD12864B)
...
#if defined(MKS_MINI_12864_V3) || defined(BTT_MINI_12864_V1)
...
#if defined(MKS_MINI_12864) || defined(ENDER2_STOCKDISPLAY)

#define MINIPANEL

//#elif ENABLED(YHCB2004)
#elif defined(YHCB2004)
...
#elif defined(DWIN_MARLINUI_PORTRAIT) || defined(DWIN_MARLINUI_LANDSCAPE)

#define IS_DWIN_MARLINUI 1
#define IS_ULTIPANEL 1

//#elif ENABLED(ZONESTAR_LCD)
#elif defined(ZONESTAR_LCD)
...
#elif defined(ZONESTAR_12864LCD)
#define DOGLCD
#define IS_RRD_SC 1
#define IS_U8GLIB_ST7920 1

//#elif ENABLED(ZONESTAR_12864OLED)
#elif defined(ZONESTAR_12864OLED)
#define IS_RRD_SC 1
#define U8GLIB_SH1106

//#elif ENABLED(ZONESTAR_12864OLED_SSD1306)
#elif defined(ZONESTAR_12864OLED_SSD1306)
#define IS_RRD_SC 1
#define IS_U8GLIB_SSD1306

//#elif ENABLED(RADDS_DISPLAY)
#elif defined(RADDS_DISPLAY)
#define IS_ULTIPANEL 1
#define STD_ENCODER_PULSES_PER_STEP 2

//#elif ANY(miniVIKI, VIKI2, WYH_L12864, ELB_FULL_GRAPHIC_CONTROLLER, AZSMZ_12864, EMOTION_TECH_LCD)
#elif defined(miniVIKI) || defined(VIKI2) || defined(WYH_L12864) || defined(ELB_FULL_GRAPHIC_CONTROLLER) || defined(AZSMZ_12864) || defined(EMOTION_TECH_LCD)
...
#elif defined(OLED_PANEL_TINYBOY2)

#define IS_U8GLIB_SSD1306
#define IS_ULTIPANEL 1

//#elif ENABLED(RA_CONTROL_PANEL)
#elif defined(RA_CONTROL_PANEL)
...
#elif defined(MKS_12864OLED)

#define IS_RRD_SC 1
#define U8GLIB_SH1106

//#elif ENABLED(MKS_12864OLED_SSD1306)
#elif defined(MKS_12864OLED_SSD1306)

#define IS_RRD_SC 1
#define IS_U8GLIB_SSD1306

//#elif ENABLED(SAV_3DGLCD)
#elif defined(SAV_3DGLCD)
...
#elif defined(FYSETC_242_OLED_12864)
...
#elif defined(FYSETC_MINI_12864_X_X) || defined(FYSETC_MINI_12864_1_2) || defined(FYSETC_MINI_12864_2_0) || defined(FYSETC_MINI_12864_2_1) || defined(FYSETC_GENERIC_12864_1_1)
...
#elif defined(MAKEBOARD_MINI_2_LINE_DISPLAY_1602)
...
#elif defined(TFTGLCD_PANEL_SPI) || defined(TFTGLCD_PANEL_I2C)
...
#elif defined(CR10_STOCKDISPLAY)
...
#elif defined(ANET_FULL_GRAPHICS_LCD) || defined(ANET_FULL_GRAPHICS_LCD_ALT_WIRING)
...
#elif defined(REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER) || defined(BQ_LCD_SMART_CONTROLLER) || defined(K3D_FULL_GRAPHIC_SMART_CONTROLLER)
...
#elif defined(K3D_242_OLED_CONTROLLER)
...
#if defined(IS_RRD_FG_SC) || defined(LCD_FOR_MELZI) || defined(SILVER_GATE_GLCD_CONTROLLER)
#define DOGLCD
#define IS_U8GLIB_ST7920 1
#define IS_RRD_SC 1
#endif
...
#if defined(MAKRPANEL) || defined(MINIPANEL)
#define IS_ULTIPANEL 1
#define DOGLCD
...
#if defined(IS_U8GLIB_SSD1306)
#define U8GLIB_SSD1306
#endif

//#if ENABLED(OVERLORD_OLED)
#if defined(OVERLORD_OLED)
#define IS_ULTIPANEL 1
#define U8GLIB_SH1106
/**
...
#if defined(U8GLIB_SSD1306) || defined(U8GLIB_SSD1309) || defined(U8GLIB_SH1106)
...
#if defined(ULTIMAKERCONTROLLER) || defined(IS_RRD_SC) || defined(G3D_PANEL) || defined(RIGIDBOT_PANEL) || defined(PANEL_ONE) || defined(U8GLIB_SH1106)
#define IS_ULTIPANEL 1
#endif

// Einstart OLED has Cardinal nav via pins defined in pins_EINSTART-S.h
//#if ENABLED(U8GLIB_SH1106_EINSTART)
#if defined(U8GLIB_SH1106_EINSTART)
#define DOGLCD
#define IS_ULTIPANEL 1
#endif
...
#if defined(FSMC_GRAPHICAL_TFT) || defined(SPI_GRAPHICAL_TFT) || defined(TFT_320x240) || defined(TFT_480x320) || defined(TFT_320x240_SPI) || defined(TFT_480x320_SPI) || defined(TFT_LVGL_UI_FSMC) || defined(TFT_LVGL_UI_SPI)
#define IS_LEGACY_TFT 1
#define TFT_GENERIC
#endif

//#if ANY(FSMC_GRAPHICAL_TFT, TFT_320x240, TFT_480x320, TFT_LVGL_UI_FSMC)
#if defined(FSMC_GRAPHICAL_TFT) || defined(TFT_320x240) || defined(TFT_480x320) || defined(TFT_LVGL_UI_FSMC)
#define TFT_INTERFACE_FSMC
//#elif ANY(SPI_GRAPHICAL_TFT, TFT_320x240_SPI, TFT_480x320_SPI, TFT_LVGL_UI_SPI)
#elif defined(SPI_GRAPHICAL_TFT) || defined(TFT_320x240_SPI) || defined(TFT_480x320_SPI) || defined(TFT_LVGL_UI_SPI)
#define TFT_INTERFACE_SPI
#endif

//#if EITHER(FSMC_GRAPHICAL_TFT, SPI_GRAPHICAL_TFT)
#if defined(FSMC_GRAPHICAL_TFT) || defined(SPI_GRAPHICAL_TFT)
#define TFT_CLASSIC_UI
//#elif ANY(TFT_320x240, TFT_480x320, TFT_320x240_SPI, TFT_480x320_SPI)
#elif defined(TFT_320x240) || defined(TFT_480x320) || defined(TFT_320x240_SPI) || defined(TFT_480x320_SPI)
#define TFT_COLOR_UI
//#elif EITHER(TFT_LVGL_UI_FSMC, TFT_LVGL_UI_SPI)
#elif defined(TFT_LVGL_UI_FSMC) || defined(TFT_LVGL_UI_SPI)
#define TFT_LVGL_UI
#endif

// FSMC/SPI TFT Panels (LVGL)
//#if ENABLED(TFT_LVGL_UI)
#if defined(TFT_LVGL_UI)
...
#if defined(IS_RRD_SC) || defined(IS_DOGM_12864) || defined(OLED_PANEL_TINYBOY2) || defined(LCD_I2C_PANELOLU2)
...
#elif defined(LCD_SAINSMART_I2C_1602) || defined(LCD_SAINSMART_I2C_2004)
...
#if (defined(LCD_I2C_TYPE_MCP23017) || defined(LCD_I2C_TYPE_MCP23008)) && !defined(NO_LCD_DETECT)
...
#if defined(FF_INTERFACEBOARD)
#define SR_LCD_3W_NL    // Non latching 3 wire shift register
#define IS_ULTIPANEL 1
//#elif ENABLED(SAV_3DLCD)
#elif defined(SAV_3DLCD)
...
#if defined(IS_ULTIPANEL) || defined(ULTRA_LCD)
#define HAS_WIRED_LCD 1
#endif

//#if EITHER(IS_ULTIPANEL, REPRAPWORLD_KEYPAD)
#if defined(IS_ULTIPANEL) || defined(REPRAPWORLD_KEYPAD)
#define IS_NEWPANEL 1
#endif

//#if EITHER(ZONESTAR_LCD, REPRAPWORLD_KEYPAD)
#if defined(ZONESTAR_LCD) || defined(REPRAPWORLD_KEYPAD)
...
#if defined(DGUS_LCD_UI_ORIGIN) || defined(DGUS_LCD_UI_FYSETC) || defined(DGUS_LCD_UI_HIPRECY) || defined(DGUS_LCD_UI_MKS)
#define HAS_DGUS_LCD_CLASSIC 1
#endif

//#if EITHER(HAS_DGUS_LCD_CLASSIC, DGUS_LCD_UI_RELOADED)
#if defined(HAS_DGUS_LCD_CLASSIC) || defined(DGUS_LCD_UI_RELOADED)
#define HAS_DGUS_LCD 1
#endif

// Extensible UI serial touch screens. (See src/lcd/extui)
//#if ANY(HAS_DGUS_LCD, MALYAN_LCD, TOUCH_UI_FTDI_EVE, ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON, NEXTION_TFT)
#if defined(HAS_DGUS_LCD) || defined(MALYAN_LCD) || defined(TOUCH_UI_FTDI_EVE) || defined(ANYCUBIC_LCD_I3MEGA) || defined(ANYCUBIC_LCD_CHIRON) || defined(NEXTION_TFT)
#define IS_EXTUI 1
...
#if defined(DWIN_CREALITY_LCD) || defined(DWIN_LCD_PROUI)
#define HAS_DWIN_E3V2_BASIC 1
#endif
//#if EITHER(HAS_DWIN_E3V2_BASIC, DWIN_CREALITY_LCD_JYERSUI)
#if defined(HAS_DWIN_E3V2_BASIC) || defined(DWIN_CREALITY_LCD_JYERSUI)
#define HAS_DWIN_E3V2 1
#endif
//#if ENABLED(DWIN_LCD_PROUI)
#if defined(DWIN_LCD_PROUI)
...
#if defined(HAS_WIRED_LCD) || defined(EXTENSIBLE_UI) || defined(DWIN_LCD_PROUI) || defined(DWIN_CREALITY_LCD_JYERSUI)
...
#if IS_ULTIPANEL && defined(NO_LCD_MENUS)
#define HAS_MARLINUI_MENU 1
#endif

//#if ANY(HAS_MARLINUI_MENU, EXTENSIBLE_UI, HAS_DWIN_E3V2)
#if defined(HAS_MARLINUI_MENU) || defined(EXTENSIBLE_UI) || defined(HAS_DWIN_E3V2)
...
#if defined(E_DUAL_STEPPER_DRIVERS) // E0/E1 steppers act in tandem as E0

#define E_STEPPERS      2
#define E_MANUAL        1

//#elif ENABLED(SWITCHING_EXTRUDER)   // One stepper for every two EXTRUDERS
#elif defined(SWITCHING_EXTRUDER)   // One stepper for every two EXTRUDERS
...
#elif defined(MIXING_EXTRUDER)      // Multiple feeds are mixed proportionally
...
#elif defined(SWITCHING_TOOLHEAD)   // Toolchanger
...
#if defined(SWITCHING_NOZZLE) || HAS_PRUSA_MMU1
#undef DISABLE_INACTIVE_EXTRUDER
#endif
...
#if defined(SINGLENOZZLE) || defined(MIXING_EXTRUDER)         // One hotend, one thermistor, no XY offset
#undef HOTENDS
#define HOTENDS       1
...
#if defined(DISTINCT_E_FACTORS) && E_STEPPERS > 1
...
#if !(defined(HAS_FAN) && defined(SINGLENOZZLE))
...
#if defined(SWITCHING_EXTRUDER) && (!defined(SWITCHING_NOZZLE) || SWITCHING_EXTRUDER_SERVO_NR != SWITCHING_NOZZLE_SERVO_NR)
...
#if defined(HAS_Z_SERVO_PROBE) || defined(SWITCHING_EXTRUDER) || defined(SWITCHING_NOZZLE)
...
#if defined(TOUCH_MI_PROBE) || defined(Z_PROBE_ALLEN_KEY) || defined(HAS_Z_SERVO_PROBE) || defined(SOLENOID_PROBE) || defined(Z_PROBE_SLED) || defined(RACK_AND_PINION_PROBE) || defined(SENSORLESS_PROBING) || defined(MAGLEV4) || defined(MAG_MOUNTED_PROBE)
#define HAS_STOWABLE_PROBE 1
#endif
//#if ANY(HAS_STOWABLE_PROBE, FIX_MOUNTED_PROBE, BD_SENSOR, NOZZLE_AS_PROBE)
#if defined(HAS_STOWABLE_PROBE) || defined(FIX_MOUNTED_PROBE) || defined(BD_SENSOR) || defined(NOZZLE_AS_PROBE)
...
#if defined(BELTPRINTER) && !defined(HOME_Y_BEFORE_X)
#define HOME_Y_BEFORE_X
#endif

//#if Z_HOME_TO_MAX && DISABLED(Z_SAFE_HOMING)
#if Z_HOME_TO_MAX && !defined(Z_SAFE_HOMING)
...
#if defined(AUTO_BED_LEVELING_LINEAR) || defined(AUTO_BED_LEVELING_3POINT)
#define ABL_PLANAR 1
#endif
...
#if defined(AUTO_BED_LEVELING_LINEAR) || defined(AUTO_BED_LEVELING_BILINEAR) || defined(AUTO_BED_LEVELING_3POINT)
#define HAS_ABL_NOT_UBL 1
#endif
//#if ANY(AUTO_BED_LEVELING_BILINEAR, AUTO_BED_LEVELING_UBL, MESH_BED_LEVELING)
#if defined(AUTO_BED_LEVELING_BILINEAR) || defined(AUTO_BED_LEVELING_UBL) || defined(MESH_BED_LEVELING)
#define HAS_MESH 1
#endif
//#if EITHER(AUTO_BED_LEVELING_UBL, AUTO_BED_LEVELING_3POINT)
#if defined(AUTO_BED_LEVELING_UBL) || defined(AUTO_BED_LEVELING_3POINT)
#define NEEDS_THREE_PROBE_POINTS 1
#endif
//#if EITHER(HAS_ABL_NOT_UBL, AUTO_BED_LEVELING_UBL)
#if defined(HAS_ABL_NOT_UBL) || defined(AUTO_BED_LEVELING_UBL)
...
#if defined(HAS_ABL_OR_UBL) || defined(MESH_BED_LEVELING)
...
#if !HAS_LEVELING || (defined(MESH_BED_LEVELING) || defined(AUTO_BED_LEVELING_UBL))
#undef PROBE_MANUALLY
#endif
//#if ANY(HAS_BED_PROBE, PROBE_MANUALLY, MESH_BED_LEVELING)
#if defined(HAS_BED_PROBE) || defined(PROBE_MANUALLY) || defined(MESH_BED_LEVELING)
...
#if defined(COREXY) || defined(COREYX)
#define CORE_IS_XY 1
#endif
//#if EITHER(COREXZ, COREZX)
#if defined(COREXZ) || defined(COREZX)
#define CORE_IS_XZ 1
#endif
//#if EITHER(COREYZ, COREZY)
#if defined(COREYZ) || defined(COREZY)
#define CORE_IS_YZ 1
#endif
...
#elif defined(MARKFORGED_XY) || defined(MARKFORGED_YX)
...
#if defined(MORGAN_SCARA) || defined(MP_SCARA) || defined(AXEL_TPARA)
#define IS_SCARA 1
#define IS_KINEMATIC 1
//#elif EITHER(DELTA, POLARGRAPH)
#elif defined(DELTA) || defined(POLARGRAPH)
#define IS_KINEMATIC 1
#else
...
#if defined(CLASSIC_JERK) || defined(IS_KINEMATIC)
#define HAS_CLASSIC_JERK 1
#endif

//#if DISABLED(CLASSIC_JERK)
#if !defined(CLASSIC_JERK)
#define HAS_JUNCTION_DEVIATION 1
#endif

// E jerk exists with JD disabled (of course) but also when Linear Advance is disabled on Delta/SCARA
//#if HAS_EXTRUDERS && (ENABLED(CLASSIC_JERK) || (IS_KINEMATIC && DISABLED(LIN_ADVANCE)))
#if HAS_EXTRUDERS && (defined(CLASSIC_JERK) || (IS_KINEMATIC && !defined(LIN_ADVANCE)))
...
#if defined(PID_DEBUG) || defined(PID_BED_DEBUG) || defined(PID_CHAMBER_DEBUG)
...
#if defined(MKS_TS35_V2_0) || defined(BTT_TFT35_SPI_V1_0)                                 // ST7796
#define TFT_DEFAULT_DRIVER ST7796
#define TFT_DEFAULT_ORIENTATION TFT_EXCHANGE_XY
#define TFT_RES_480x320
#define TFT_INTERFACE_SPI
//#elif EITHER(LERDGE_TFT35, ANET_ET5_TFT35)                                    // ST7796
#elif defined(LERDGE_TFT35) || defined(ANET_ET5_TFT35)                                    // ST7796
#define TFT_DEFAULT_ORIENTATION TFT_EXCHANGE_XY
#define TFT_RES_480x320
#define TFT_INTERFACE_FSMC
//#elif ANY(ANET_ET4_TFT28, MKS_ROBIN_TFT24, MKS_ROBIN_TFT28, MKS_ROBIN_TFT32)  // ST7789
#elif defined(ANET_ET4_TFT28) || defined(MKS_ROBIN_TFT24) || defined(MKS_ROBIN_TFT28) || defined(MKS_ROBIN_TFT32)  // ST7789
#define TFT_DEFAULT_ORIENTATION (TFT_EXCHANGE_XY | TFT_INVERT_Y)
#define TFT_RES_320x240
#define TFT_INTERFACE_FSMC
//#elif ANY(MKS_ROBIN_TFT35, TFT_TRONXY_X5SA, ANYCUBIC_TFT35)                   // ILI9488
#elif defined(MKS_ROBIN_TFT35) || defined(TFT_TRONXY_X5SA) || defined(ANYCUBIC_TFT35)                   // ILI9488
#define TFT_DRIVER ILI9488
#define TFT_DEFAULT_ORIENTATION (TFT_EXCHANGE_XY | TFT_INVERT_X | TFT_INVERT_Y)
#define TFT_RES_480x320
#define TFT_INTERFACE_FSMC
//#elif ENABLED(MKS_ROBIN_TFT43)
#elif defined(MKS_ROBIN_TFT43)
#define TFT_DRIVER SSD1963
#define TFT_DEFAULT_ORIENTATION 0
#define TFT_RES_480x272
#define TFT_INTERFACE_FSMC
//#elif EITHER(MKS_ROBIN_TFT_V1_1R, LONGER_LK_TFT28)                            // ILI9328 or R61505
#elif defined(MKS_ROBIN_TFT_V1_1R) || defined(LONGER_LK_TFT28)                            // ILI9328 or R61505
#define TFT_DEFAULT_ORIENTATION (TFT_EXCHANGE_XY | TFT_INVERT_X | TFT_INVERT_Y)
#define TFT_RES_320x240
#define TFT_INTERFACE_FSMC
//#elif ENABLED(BIQU_BX_TFT70)                                                  // RGB
#elif defined(BIQU_BX_TFT70)                                                  // RGB
#define TFT_DEFAULT_ORIENTATION TFT_EXCHANGE_XY
...
#if defined(TFT_RES_320x240)
#define TFT_WIDTH  320
#define TFT_HEIGHT 240
#define GRAPHICAL_TFT_UPSCALE 2
//#elif ENABLED(TFT_RES_480x272)
#elif defined(TFT_RES_480x272)
#define TFT_WIDTH  480
#define TFT_HEIGHT 272
#define GRAPHICAL_TFT_UPSCALE 2
//#elif ENABLED(TFT_RES_480x320)
#elif defined(TFT_RES_480x320)
#define TFT_WIDTH  480
#define TFT_HEIGHT 320
#define GRAPHICAL_TFT_UPSCALE 3
//#elif ENABLED(TFT_RES_1024x600)
#elif defined(TFT_RES_1024x600)
...
#elif defined(TFT_INTERFACE_SPI)
...
#elif defined(TFT_INTERFACE_LTDC)
...
#if defined(TFT_320x240) || defined(TFT_320x240_SPI)
#define HAS_UI_320x240 1
##elif EITHER(TFT_480x320, TFT_480x320_SPI)
#elif defined(TFT_480x320) || defined(TFT_480x320_SPI)
#define HAS_UI_480x320 1
//#elif EITHER(TFT_480x272, TFT_480x272_SPI)
#elif defined(TFT_480x272) || defined(TFT_480x272_SPI)
#define HAS_UI_480x272 1
//#elif EITHER(TFT_1024x600_LTDC, TFT_1024x600_SIM)
#elif defined(TFT_1024x600_LTDC) || defined(TFT_1024x600_SIM)
#define HAS_UI_1024x600 1
#endif
//#if ANY(HAS_UI_320x240, HAS_UI_480x320, HAS_UI_480x272)
#if defined(HAS_UI_320x240) || defined(HAS_UI_480x320) || defined(HAS_UI_480x272)
