...
#if defined(HAS_JUNCTION_DEVIATION) && defined(LIN_ADVANCE)
...
#if defined(AXIS4_ROTATES) || defined(AXIS5_ROTATES) || defined(AXIS6_ROTATES) || defined(AXIS7_ROTATES) || defined(AXIS8_ROTATES) || defined(AXIS9_ROTATES)
...
#if defined(BACKLASH_GCODE) || defined(CALIBRATION_GCODE)
...
#if defined(FWRETRACT) && !defined(MAX_AUTORETRACT)
...
#if PIN_EXISTS(X_ENABLE) || (defined(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(X))
...
#if PIN_EXISTS(X2_ENABLE) || (defined(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(X2))
...
#if !defined(DISABLE_INACTIVE_X) && defined(DISABLE_X)
#define DISABLE_INACTIVE_X 1
#endif

#if HAS_Y_AXIS
//#if PIN_EXISTS(Y_ENABLE) || (ENABLED(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(Y))
#if PIN_EXISTS(Y_ENABLE) || (defined(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(Y))
...
#if PIN_EXISTS(Y2_ENABLE) || (defined(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(Y2))
...
#if !defined(DISABLE_INACTIVE_Y) && defined(DISABLE_Y)
...
#if PIN_EXISTS(Z_ENABLE) || (defined(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(Z))
...
#if !defined(DISABLE_INACTIVE_Z) && defined(DISABLE_Z)
...
#if PIN_EXISTS(E0_ENABLE) || (defined(SOFTWARE_DRIVER_ENABLE) && AXIS_IS_TMC(E0))
...
#if E_STEPPERS > 1 || defined(E_DUAL_STEPPER_DRIVERS)
...
#if !defined(DISABLE_INACTIVE_E) && defined(DISABLE_E)
...
#if defined(THERMAL_PROTECTION_HOTENDS) && WATCH_TEMP_PERIOD > 0
#define WATCH_HOTENDS 1
#endif
//#if ENABLED(THERMAL_PROTECTION_BED) && WATCH_BED_TEMP_PERIOD > 0
#if defined(THERMAL_PROTECTION_BED) && WATCH_BED_TEMP_PERIOD > 0
#define WATCH_BED 1
#endif
//#if BOTH(HAS_HEATED_CHAMBER, THERMAL_PROTECTION_CHAMBER) && WATCH_CHAMBER_TEMP_PERIOD > 0
#if (defined(HAS_HEATED_CHAMBER) && defined(THERMAL_PROTECTION_CHAMBER)) && WATCH_CHAMBER_TEMP_PERIOD > 0
#define WATCH_CHAMBER 1
#endif
//#if BOTH(HAS_COOLER, THERMAL_PROTECTION_COOLER) && WATCH_COOLER_TEMP_PERIOD > 0
#if (defined(HAS_COOLER) && defined(THERMAL_PROTECTION_COOLER)) && WATCH_COOLER_TEMP_PERIOD > 0
...
#if !defined(THERMAL_PROTECTION_HOTENDS) && !defined(THERMAL_PROTECTION_CHAMBER) && !defined(THERMAL_PROTECTION_BED) && !defined(THERMAL_PROTECTION_COOLER)
...
*/
#if  (defined(THERMAL_PROTECTION_HOTENDS) || !EXTRUDERS) \
  && (defined(THERMAL_PROTECTION_BED)     || !HAS_HEATED_BED) \
  && (defined(THERMAL_PROTECTION_CHAMBER) || !HAS_HEATED_CHAMBER) \
  && (defined(THERMAL_PROTECTION_COOLER)  || !HAS_COOLER)
...
#if defined(HAS_AUTO_FAN_0) || defined(HAS_AUTO_FAN_1) || defined(HAS_AUTO_FAN_2) || defined(HAS_AUTO_FAN_3) || defined(HAS_AUTO_FAN_4) || defined(HAS_AUTO_FAN_5) || defined(HAS_AUTO_FAN_6) || defined(HAS_AUTO_FAN_7) || defined(HAS_AUTO_CHAMBER_FAN) || defined(HAS_AUTO_COOLER_FAN)
...
#if defined(HAS_E0_FAN_TACHO) || defined(HAS_E1_FAN_TACHO) defined(HAS_E2_FAN_TACHO) || defined(HAS_E3_FAN_TACHO) || defined(HAS_E4_FAN_TACHO) || defined(HAS_E5_FAN_TACHO) || defined(HAS_E6_FAN_TACHO) || defined(HAS_E7_FAN_TACHO)
...
#if defined(AUTO_REPORT_TEMPERATURES) || defined(AUTO_REPORT_SD_STATUS) || defined(AUTO_REPORT_POSITION) || defined(AUTO_REPORT_FANS)
...
#if defined(FREEZE_FEATURE) && !PIN_EXISTS(FREEZE) && PIN_EXISTS(KILL)
...
#if defined(HAS_Z_MS_PINS) || defined(HAS_Z2_MS_PINS) || defined(HAS_Z3_MS_PINS) || defined(HAS_Z4_MS_PINS)
...
#if defined(HAS_E0_MS_PINS) || defined(HAS_E1_MS_PINS) || defined(HAS_E2_MS_PINS) || defined(HAS_E3_MS_PINS) || defined(HAS_E4_MS_PINS) || defined(HAS_E5_MS_PINS) || defined(HAS_E6_MS_PINS) || defined(HAS_E7_MS_PINS)
...
#if defined(HAS_X_MS_PINS) || defined(HAS_X2_MS_PINS) || defined(HAS_Y_MS_PINS) || defined(HAS_Y2_MS_PINS) || defined(HAS_SOME_Z_MS_PINS) || defined(HAS_I_MS_PINS) || defined(HAS_J_MS_PINS) || defined(HAS_K_MS_PINS) || defined(HAS_U_MS_PINS) || defined(HAS_V_MS_PINS) || defined(HAS_W_MS_PINS) || defined(HAS_SOME_E_MS_PINS)
...
#if defined(HAS_MULTI_HOTEND) || defined(HEATERS_PARALLEL)
...
#if HAS_TEMPERATURE && (defined(HAS_MARLINUI_MENU) || defined(HAS_DWIN_E3V2) || defined(HAS_DGUS_LCD_CLASSIC))
...
#if defined(MESH_BED_LEVELING) || defined(HAS_BED_PROBE)
...
#if !(defined(HAS_BED_PROBE) || defined(HAS_FAN))
#undef PROBING_FANS_OFF
#endif
#if !(defined(HAS_BED_PROBE) || defined(HAS_EXTRUDERS))
#undef PROBING_ESTEPPERS_OFF
//#elif ENABLED(PROBING_STEPPERS_OFF)
#elif defined(PROBING_STEPPERS_OFF)
...
#if defined(ADVANCED_PAUSE_FEATURE) || defined(PROBING_HEATERS_OFF)
...
#if HAS_BED_PROBE && (defined(PROBING_HEATERS_OFF) || defined(PROBING_STEPPERS_OFF) || defined(PROBING_ESTEPPERS_OFF) || defined(PROBING_FANS_OFF)) || (DELAY_BEFORE_PROBING > 0)
...
#if defined(SEGMENT_LEVELED_MOVES) && !defined(LEVELED_SEGMENT_LENGTH)
...
#if defined(IS_TFTGLCD_PANEL) || defined(PCA9632_BUZZER) || defined(LCD_USE_I2C_BUZZER)
#define USE_MARLINUI_BUZZER 1
#endif
//#if EITHER(HAS_BEEPER, USE_MARLINUI_BUZZER)
#if defined(HAS_BEEPER) || defined(USE_MARLINUI_BUZZER)
#define HAS_SOUND 1
#endif

//#if ENABLED(LCD_USE_I2C_BUZZER)
#if defined(LCD_USE_I2C_BUZZER)
...
#if defined(MESH_BED_LEVELING) || defined(PROBE_MANUALLY)
...
#elif defined(AUTO_BED_LEVELING_UBL) && defined(Z_CLEARANCE_BETWEEN_PROBES)
...
#if defined(G38_PROBE_TARGET) || defined(CNC_COORDINATE_SYSTEMS) || defined(POWER_LOSS_RECOVERY)
#define USE_GCODE_SUBCODES 1
#endif

// Parking Extruder
//#if ENABLED(PARKING_EXTRUDER)
#if defined(PARKING_EXTRUDER)
...
#if defined(SCROLL_LONG_FILENAMES) || defined(HAS_DWIN_E3V2)
...
#if defined(NOZZLE_PARK_FEATURE) && defined(DELTA)
...
*/
#if defined(ENDSTOPPULLDOWNS) || defined(ENDSTOPPULLDOWN_ZMIN_PROBE) \
    defined(ENDSTOPPULLDOWN_XMIN) || defined(ENDSTOPPULLDOWN_YMIN) || defined(ENDSTOPPULLDOWN_ZMIN) \
    defined(ENDSTOPPULLDOWN_IMIN) || defined(ENDSTOPPULLDOWN_JMIN) || defined(ENDSTOPPULLDOWN_KMIN) \
    defined(ENDSTOPPULLDOWN_XMAX) || defined(ENDSTOPPULLDOWN_YMAX) || defined(ENDSTOPPULLDOWN_ZMAX) \
    defined(ENDSTOPPULLDOWN_IMAX) || defined(ENDSTOPPULLDOWN_JMAX) || defined(ENDSTOPPULLDOWN_KMAX) \
    defined(POWER_LOSS_PULLDOWN) || defined(CALIBRATION_PIN_PULLDOWN) || defined(FIL_RUNOUT_PULLDOWN) \
    defined(FIL_RUNOUT1_PULLDOWN) || defined(FIL_RUNOUT2_PULLDOWN) || defined(FIL_RUNOUT3_PULLDOWN) || defined(FIL_RUNOUT4_PULLDOWN) \
    defined(FIL_RUNOUT5_PULLDOWN) || defined(FIL_RUNOUT6_PULLDOWN) || defined(FIL_RUNOUT7_PULLDOWN) || defined(FIL_RUNOUT8_PULLDOWN)
