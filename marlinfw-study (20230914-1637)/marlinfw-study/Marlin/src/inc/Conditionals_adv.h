...
#if defined(HAS_Z_SERVO_PROBE) || defined(CHAMBER_VENT) || defined(SWITCHING_TOOLHEAD) || defined(SWITCHING_EXTRUDER) || defined(SWITCHING_NOZZLE) || defined(SPINDLE_SERVO)
...
#if defined(BLTOUCH) && NUM_SERVOS == 1
#undef SERVO_DELAY
...
#if defined(MIXING_EXTRUDER) && (defined(RETRACT_SYNC_MIXING) || (defined(FILAMENT_LOAD_UNLOAD_GCODES) && defined(FILAMENT_UNLOAD_ALL_EXTRUDERS)))
#define HAS_MIXER_SYNC_CHANNEL 1
#endif

//#if EITHER(DUAL_X_CARRIAGE, MULTI_NOZZLE_DUPLICATION)
#if defined(DUAL_X_CARRIAGE) || defined(MULTI_NOZZLE_DUPLICATION)
#define HAS_DUPLICATION_MODE 1
#endif

//#if ENABLED(PRINTCOUNTER) && (SERVICE_INTERVAL_1 > 0 || SERVICE_INTERVAL_2 > 0 || SERVICE_INTERVAL_3 > 0)
#if defined(PRINTCOUNTER) && (SERVICE_INTERVAL_1 > 0 || SERVICE_INTERVAL_2 > 0 || SERVICE_INTERVAL_3 > 0)
...
#if defined(NO_SD_AUTOSTART)
#undef MENU_ADDAUTOSTART
#endif

//#if EITHER(SDSUPPORT, SET_PROGRESS_MANUALLY)
#if defined(SDSUPPORT) || defined(SET_PROGRESS_MANUALLY)
...
#if defined(HAS_MARLINUI_MENU) || defined(ULTIPANEL_FEEDMULTIPLY) || defined(SOFT_RESET_ON_KILL)
...
#if defined(SDSUPPORT) && SD_PROCEDURE_DEPTH
#define HAS_MEDIA_SUBCALLS 1
#endif

//#if HAS_PRINT_PROGRESS && EITHER(PRINT_PROGRESS_SHOW_DECIMALS, SHOW_REMAINING_TIME)
#if HAS_PRINT_PROGRESS && (defined(PRINT_PROGRESS_SHOW_DECIMALS) && defined(SHOW_REMAINING_TIME))
#define HAS_PRINT_PROGRESS_PERMYRIAD 1
#endif

//#if ANY(MARLIN_BRICKOUT, MARLIN_INVADERS, MARLIN_SNAKE, MARLIN_MAZE)
#if defined(MARLIN_BRICKOUT) || defined(MARLIN_INVADERS) || defined(MARLIN_SNAKE) || defined(MARLIN_MAZE)
#define HAS_GAMES 1
...
#if defined(FWRETRACT) || defined(HAS_LEVELING) || defined(SKEW_CORRECTION)
#define HAS_POSITION_MODIFIERS 1
#endif

//#if ANY(X_DUAL_ENDSTOPS, Y_DUAL_ENDSTOPS, Z_MULTI_ENDSTOPS)
#if defined(X_DUAL_ENDSTOPS) || defined(Y_DUAL_ENDSTOPS) || defined(Z_MULTI_ENDSTOPS)
...
#if defined(EXTENSIBLE_UI) || defined(IS_NEWPANEL) || defined(EMERGENCY_PARSER) || defined(HAS_ADC_BUTTONS) || defined(HAS_DWIN_E3V2)
...
#if defined(HAS_RESUME_CONTINUE) && defined(PRINTER_EVENT_LEDS) && defined(SDSUPPORT)
...
#if defined(X2_DRIVER_TYPE) && !defined(DUAL_X_CARRIAGE)
...
#if defined(HOST_PROMPT_SUPPORT) && !defined(EMERGENCY_PARSER)
...
#if defined(FYSETC_MINI_12864_2_1) || defined(FYSETC_242_OLED_12864)
...
#if defined(LED_CONTROL_MENU) && defined(NEOPIXEL2_SEPARATE)
...
#if defined(TFT_TOUCH_DEVICE_XPT2046) || defined(HAS_TFT_LVGL_UI)
...
#if defined(TOUCH_UI_FTDI_EVE) && (defined(AO_EXP1_PINMAP) || defined(AO_EXP2_PINMAP) || defined(CR10_TFT_PINMAP))
...
#if defined(USB_FLASH_DRIVE_SUPPORT) && (!defined(USE_OTG_USB_HOST) && !defined(USE_UHS3_USB))
#define USE_UHS2_USB
#endif
...
#if defined(POWER_MONITOR_CURRENT) || defined(POWER_MONITOR_VOLTAGE)
...
#if defined(EEPROM_SETTINGS) && (!defined(I2C_EEPROM) && !defined(SPI_EEPROM) && !defined(QSPI_EEPROM) && !defined(FLASH_EEPROM_EMULATION) && !defined(SRAM_EEPROM_EMULATION) && !defined(SDCARD_EEPROM_EMULATION))
...
#if defined(AUTO_BED_LEVELING_UBL) || defined(M100_FREE_MEMORY_WATCHER) || defined(DEBUG_GCODE_PARSER) || defined(TMC_DEBUG) || defined(MARLIN_DEV_MODE) || defined(DEBUG_CARDREADER) || defined(M20_TIMESTAMP_SUPPORT))
...
#if defined(CASE_LIGHT_ENABLE) && (!defined(CASE_LIGHT_NO_BRIGHTNESS) && !defined(CASE_LIGHT_IS_COLOR_LED)) || defined(CASE_LIGHT_USE_NEOPIXEL))
...
#if defined(AUTO_BED_LEVELING_UBL) || defined(AUTO_BED_LEVELING_LINEAR) || defined(HAS_Z_STEPPER_ALIGN_STEPPER_XY)
#define NEED_LSF 1
#endif

//#if BOTH(HAS_TFT_LVGL_UI, CUSTOM_MENU_MAIN)
#if defined(HAS_TFT_LVGL_UI) && defined(CUSTOM_MENU_MAIN)
...
#if defined(MEATPACK_ON_SERIAL_PORT_1) || defined(MEATPACK_ON_SERIAL_PORT_2)
...
#if defined(CONFIGURATION_EMBEDDING) && !defined(FORCE_CONFIG_EMBED) && (defined(__AVR__) || !defined(SDSUPPORT) || (defined(SDCARD_READONLY) || defined(DISABLE_M503)))
...
#if defined(DISABLE_INACTIVE_X) || defined(DISABLE_INACTIVE_Y) || defined(DISABLE_INACTIVE_Z) || defined(DISABLE_INACTIVE_I) || defined(DISABLE_INACTIVE_J) || defined(DISABLE_INACTIVE_K) || defined(DISABLE_INACTIVE_U) || defined(DISABLE_INACTIVE_V) || defined(DISABLE_INACTIVE_W) || defined(DISABLE_INACTIVE_E)
